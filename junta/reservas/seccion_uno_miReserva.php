	...
	if ($oper_e != 0) {
	?>
	<div class='disponible' <?php echo $datas ?> style="display:inline-block;height:30px;width:<?php echo $oper_e ?>%;background-color:brown;margin-right:-5px;border:1px solid black">
		  	<p class="p_hora_mens">Disponible</p>
	</div>
	<?php
	}
