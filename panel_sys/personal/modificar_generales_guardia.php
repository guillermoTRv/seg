...
<div class="row">
	<div class="col-md-10">
		...
		<form method="post" enctype="multipart/form-data" class="control_inline">
			...
			<div id="4" style="display:none">
				...
				<div class="group_inline">
					...
					<li class="li_select">
						<p class="p_select element_ol"><span class="icon-circle-down"></span> <?php echo $inmueble ?></p>
						<ul class="ul_menu">
							<?php 
						...
						<input type="hidden" name="inmueble_txt" value="<?php echo $inmueble ?>">
					</li>	
				</div>
				<div class="group_inline">
					<div class="label_inline">
		...
		<hr>
		<a href="?pr=opciones_modificar_guardia&val=<?php echo $val ?>" class="blue"><span class="icon-undo2"></span> Regresar a la opciones de modificacion</a>
	</div>
</div>
<script>
	formulario_control_secuencia("panel_sys/personal/process_modificar_guardia.php",5)
