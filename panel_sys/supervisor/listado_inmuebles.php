...
<div class="row">
  <div class="col-md-11">
    <h2><span class="icon-office"></span> Inmuebles para que estan a su cargo</h2>
    <br>
  </div>
  <div class="col-md-11">
    ...
    <div class="div_blanco" style="background-color:#fff">  
        <table class="table table-hover">
            ...
            <tbody>
                <?php 
                                $q_inmuebles = mysqli_query($q_sec,"SELECT * FROM inmuebles WHERE supervisor = '$num_user' order by id_inmueble ASC");
