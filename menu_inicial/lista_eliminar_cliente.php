<div class="col-md-11">
	<h2><span class="glyphicon glyphicon-list-alt"></span> Baja de Clientes</h2>
			...
			<tbody>
				...
				while ($array = mysqli_fetch_array($consulta)) {
					...
					<tr>
						...
						<td><a type="button" class="btn btn-danger btn-xs" href="?cont=eliminar&val=<?php echo $id_cliente ?>">eliminar</a></td>
					</tr>
					<?php
				}
				?>
