<div class="col-md-11">
	<h2><span class="glyphicon glyphicon-list-alt"></span> Modificación de datos de sus Clientes</h2>
			...
			<tbody>
				...
				while ($array = mysqli_fetch_array($consulta)) {
					...
					<tr>
						...
						<td><a type="button" class="btn btn-primary btn-xs" href="?cont=modificar&val=<?php echo $id_cliente ?>">modifcar</a></td>
					</tr>
					<?php
				}
				?>
