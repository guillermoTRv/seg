    <li class="li_nav">
        <a href="?ck=llenar" class="title_a" data="?ck=llenar"><span class="icon-clipboard"></span> Llenar checklist</a>
    </li>
    <li class="li_nav">
    ...
    <!--que el guardia tambien pueda ver su historial de reportes-->
